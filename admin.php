            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="edit.php">editar</a></li>
                        <li class="nav-item"><a class="nav-link" href="index.php">cerrar sesi&oacute;n</a></li>
        ...
        <section class="page-section" id="letras">
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="row text-center">
                        <h2>La Canci&oacute;n de las Vocales</h2>
                        <br />
